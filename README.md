...
[Docker Hub Repository](https://hub.docker.com/repository/docker/nkond22/todoapp)

To pull an image:
```
docker pull nkond22/todoapp
```
...
Now you can browse the [landing page](http://localhost:8080/).
